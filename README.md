...
- [x] [`PercentStackedColumnChart`](https://g2plot.antv.vision/zh/examples/column/percentStacked)
...
- [x] [`PercentStackedBarChart`](https://g2plot.antv.vision/zh/examples/bar/percentStacked)
...
- [x] [`PercentStackedAreaChart`](https://g2plot.antv.vision/zh/examples/area/percentArea)
